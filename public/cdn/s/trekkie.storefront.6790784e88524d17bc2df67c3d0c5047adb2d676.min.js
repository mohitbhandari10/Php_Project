! function() {
    var e = {
            ...
            1148: function(e, t, n) {
                ...
                }, t.currentVisitorConsent = l, t.marketingAllowed = d, t.preferencesProcessingAllowed = function() {
                    return o.havePreferencesConsent()
                }, t.saleOfDataAllowed = p, t.setTrackingConsent = f, t.shopifyConsentAPI = function(e = {
            ...
            5732: function(e, t, n) {
                ...
                t.CONSENT_COOKIE_NAME = i, t.analyticsProcessingAllowed = function() {
                    return p(o.DataProcessingPurpose.ANALYTICS)
                }, t.getCCPAConsentValue = function() {
                    return c()[o.ConsentKeys.SALE_OF_DATA]
                }, t.getCMPConsentValues = c, t.getConsentId = function() {
                    const e = a();
                    ...
                    const e = s();
                    return u(e) ? "" : e.region || ""
                }, t.getSignal = d, t.marketingProcessingAllowed = function() {
                ...
                }, t.readCookieAndTransform = s, t.saleOfDataAllowed = function() {
            ...
            5730: function(e, t, n) {
                ...
                function f() {
                    return !1 === l() ? o.DisplayConsentValues.DECLINED : (e = r.getCCPAConsentValue(), r.validCookieDoesNotExist() ? o.DisplayConsentValues.NO_VALUE : e === o.ConsentValues.NO_VALUE ? o.DisplayConsentValues.NO_INTERACTION : r.transformConsentToDisplaySchema(e));
                    var e
                }
                t.saleOfDataRegion = r.saleOfDataRegion, t.GPCSignal = l, t.doesMerchantSupportGranularConsent = function() {
                    return !0
                ...
                }, t.hasConsentForGDPR = p, t.haveAnalyticsConsent = function() {
                    ...
                    return (new i.Monorail).produce("shouldShowCCPABanner"), s.logger.warn("shouldShowCCPABanner is deprecated and will be removed."), r.saleOfDataRegion() && f() === o.DisplayConsentValues.NO_INTERACTION
            ...
            809: function(e, t, n) {
                ...
                function r(e, t = !1) {
                    ...
                    for (let t = 0; t < n.length; t++) {
                        const [o, r] = n[t].split("=");
                        if (e === decodeURIComponent(o)) return decodeURIComponent(r)
                    }
                    if (t && "_tracking_consent" === e && !window.localStorage.getItem("tracking_consent_fetched")) {
                        if (o.isTestEnv()) return;
                        return console.debug("_tracking_consent missing"), i(), window.localStorage.setItem("tracking_consent_fetched", "true"), r(e, !1)
                    }
                }
                ...
                t.makeSynchronousRequest = i, t.readCookie = function(e) {
                    return r(e)
            ...
            8680: function(e, t, n) {
                ...
                t.storefrontApiUpdateTrackingConsent = function(e, t) {
                    ...
                    return fetch(`https://${l}/api/unstable/graphql.json`, _).then((e => {
                        ...
                        const l = 31536e6,
                            ...
                            E = _ || n.checkoutRootDomain || window.location.hostname,
                        ...
                        return r.writeCookie(i.CONSENT_COOKIE_NAME, E, l, g), v && y && (r.writeCookie(u, E, f, v), r.writeCookie(d, E, f, y)), h !== E && (r.writeCookie(i.CONSENT_COOKIE_NAME, h, l, g), v && y && (r.writeCookie(u, h, f, v), r.writeCookie(d, h, f, y))), o.dispatchEvents(e), c.appendConsentToCustomerAccountLinks(m), void 0 !== t && t(null, a), a
                    })).catch((e => {
                ...
                var g = function(e) {
                    ...
                    return r(n, e), n.prototype.name = function() {
                        ...
                        return i(i({
                            ...
                            asset_version_id: "6790784e88524d17bc2df67c3d0c5047adb2d676",
                        ...
                        }), _.default.eventMetadataId && {
                            event_metadata_id: _.default.eventMetadataId
                        }))
            ...
            3811: function(e, t) {
                ...
                Object.defineProperty(t, "__esModule", {
                    value: !0
                }), t.TREKKIE_PCIV4 = t.TREKKIE_GOOGLE_CONSENT_MODE_WITH_CONSENT_SIGNALS = t.TREKKIE_COOKIE_DOMAIN_FIX = void 0;
                var n = new(function() {
                    function e() {
                        this.betaFlagsProps = []
                    }
                ...
                t.TREKKIE_COOKIE_DOMAIN_FIX = "65f19447", t.TREKKIE_GOOGLE_CONSENT_MODE_WITH_CONSENT_SIGNALS = "6ebf83d2", t.TREKKIE_PCIV4 = "7b0a8845", t.default = n
            },
            4252: function(e, t, n) {
                "use strict";
                Object.defineProperty(t, "__esModule", {
                    ...
                    if (void 0 === o && (!l.default.isEnabled(l.TREKKIE_COOKIE_DOMAIN_FIX) || T(e)))
                        if (function() {
                            ...
                            for (var t = "", n = 0, r = d.hostname().split(".").reverse(); n < r.length; n++) {
                                ...
                                if (y(e, a, 0, t), v(e, a)) return void(o = t)
                            }
                            o = ""
                        }
                }
                ...
                t.parseDocumentCookie = h, t.cookieImpl = {
                    ...
                    write: function(e, n, o) {
                        if (void 0 === o && (o = {}), T(e)) {
                            ...
                            o.maxage && (o.maxage < 0 ? o.expires = E : o.expires = new Date((new Date).getTime() + o.maxage)), o.path && (r += "; path=" + o.path), o.domain && (r += "; domain=" + o.domain), (o.maxage < 0 || o.expires) && (r += "; expires=" + o.expires.toUTCString()), o.samesite ? r += "; SameSite=" + o.samesite : r += "; SameSite=Lax", o.secure && (r += "; secure");
                            try {
                    ...
                    void 0 === r && (r = "Lax"), g(e), y(e, t, n ? 31104e6 : 18e5, o, r)
                }, t.clear = function(e) {
                    g(e), y(e, "", -1, o), y(e, "", -1, "")
                }, t.cleanupOverScopedCookies = function() {
                    if (C())
                        for (var e = 0, t = ["_shopify_s", "_shopify_sa_p", "_shopify_sa_t", "_shopify_y"]; e < t.length; e++) {
                            var n = t[e] + "=; domain=." + f + "; path=/; max-age=0; expires=Thu, 01 Jan 1970 00:00:01 GMT; SameSite=Lax";
                            i.virtualDocument().setCookie(n)
                        }
                }, t.determineCookieDomain = g, t.resetCookieImpl = function() {
                    o = void 0, r = void 0
                }
            },
            4779: function(e, t, n) {
            ...
            1037: function(e, t, n) {
                ...
                t.metricsSchemaId = "trekkie_metrics/2.0", t.errorsSchemaId = "trekkie_errors/2.0", t.setGlobalSerializedAppConfig = function(e) {
                    ...
                    if (this.shouldSendToBugsnag()) {
                        var n = "6790784e88524d17bc2df67c3d0c5047adb2d676",
                            o = null,
                            r = null,
                            i = null;
                        if (e.appConfig) try {
                    ...
                    y = function() {
                        ...
                        return e.prototype.configureMonorailRegion = function(e) {
                            ...
                            a.addBatchEvent({
                                ...
                                payload: {
                                    build_id: "6790784e88524d17bc2df67c3d0c5047adb2d676",
                            ...
                            var s = {
                                ...
                                c = e === f.TEST_DEFAULT_PREVENTED_ADDED_PRODUCT_EVENT_NAME || "Added Product Next" === e ? "Added Product" : e,
            ...
            3552: function(e, t, n) {
                ...
                function f() {
                    window.Shopify = window.Shopify || {}, window.Shopify.evids || (d = {}, p = {
                        [a]: {},
                        [s]: {},
                        [c]: {},
                        [u]: {}
                        ...
                        if (! function(e) {
                                return i.includes(e)
                            }(e) || (null == t ? void 0 : t.analyticsFramework) !== s && (null == t ? void 0 : t.analyticsFramework) !== a && (null == t ? void 0 : t.analyticsFramework) !== c && (null == t ? void 0 : t.analyticsFramework) !== u) return l(r);
        ...
        function() {
            ...
            try {
                ...
                if (p) {
                    ...
                    var l = window[r],
                        f = window.trekkie = new e.Tricorder(i, p, (function() {
                            window[r] = f, window._visit = {
                                tag: function() {},
